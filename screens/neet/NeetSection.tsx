...
function NeetSection(prop: any): JSX.Element {
  const courses = [
    { title: 'ASPIRE', heading1: 'NEET + XI', heading2: '2 Year Course', subject: '', screen: 'Test' },
    ...
    <SafeAreaView>
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        <View>
          ...
          {/* <View style={{width:'100%', margin:0, flex: 1, flexDirection:'row', alignItems: 'center', justifyContent: 'center' , flexWrap: 'wrap'}}> 
                <View >
                  <TouchableOpacity  onPress={() => prop.navigation.navigate('Test')}>
                    <View style={[{backgroundColor:color.primary, width:86, height: 86 ,padding:4, margin:5,flex: 1, flexDirection:'column', alignItems: 'center', justifyContent: 'center',borderBottomRightRadius:25}]}>
                      <Text style={[styles.optionTitle,styles.highlight, {color:color.theme_white} ]}>ASPIRE</Text>
                      <Text style={[styles.optionHeading1,{color:color.black}]}>NEET + XI</Text>
                      <Text style={[styles.optionHeading2,{color:color.dark}  ]}>2 Year Course</Text>
                    </View>
                    </TouchableOpacity>
                </View>
